<%@ Page Language="C#" Title = "Agregar Movimiento de Caja Chica" AutoEventWireUp="true" CodeBehind="frmMovCajaChicaAddQuick.aspx.cs" Inherits="Garibay.frmMovCajaChicaAddQuick" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="True" ScriptMode="Release">
            <Scripts>
                <asp:ScriptReference Path="/scripts/AjaxErrHandler.js" />
            </Scripts>
    </asp:ScriptManager>
                ...
                <tr>
                       ...
                       <tr>
                            <td align="center">
                                ...
                                <asp:Label ID="lblReminder" runat="server" Font-Size="X-Large" 
                                    Text="NO OLVIDE ACTUALIZAR LA LISTA DE MOVIMIENTOS DE CAJA CHICA"></asp:Label>
    ...
    <table>
	    <tr>
		    <td align="center" class="TableHeader" colspan="2">
		        ...
		        <asp:Label ID="lblNotadeVentaID" runat="server" 
                    Visible="False"></asp:Label>
    		
		        <asp:Label ID="lblNotadeCompraID" runat="server" Visible="False"></asp:Label>
	    ...
	    <tr>
	        ...
	        <td >
	            <asp:DropDownList ID="ddlBodegas" runat="server" AutoPostBack="True" 
                    DataSourceID="sdsBodegas" DataTextField="bodega" DataValueField="bodegaID" onselectedindexchanged="ddlBodegas_SelectedIndexChanged" 
                    >
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpdlCatalogoInterno" runat="server" AutoPostBack="True" 
                    ...
                    onselectedindexchanged="drpdlCatalogoInterno_SelectedIndexChanged">
                </asp:DropDownList>
