...
// Componente: PopCalendarAjaxNet.js(1.0.5)
// Correo: ricaj0625@yahoo.com
// Última actualización: 04 de junio de 2009
// Por favor mantenga estos créditos (Please, keep these credits)

if(typeof(objPopCalList)=='undefined')
{
	var objPopCalList=[]
	var PopCalendar={majorVersion:1,minorVersion:0.5,newCalendar:new Function("_name","return(PopCalGetCalendarInstance(_name))")}
}
