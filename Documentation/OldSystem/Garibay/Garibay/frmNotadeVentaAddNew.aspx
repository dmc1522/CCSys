<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" Title = "Agregar una nota de venta" AutoEventWireup="True" CodeBehind="frmNotadeVentaAddNew.aspx.cs" Inherits="Garibay.frmNotadeVentaAddNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr> 
        <td align="right">
            <asp:HyperLink ID="lnkNewNV" runat="server" 
       ...
       <tr>
          <td align="center">
                    <asp:DropDownList ID="cmbCiclo" runat="server" DataSourceID="sdsCiclos" 
                        ...
                        Width="181px" AutoPostBack="True" ondatabound="cmbCiclo_DataBound" 
...
<%-- panel de datos de transporte --%>
                ...
                <asp:CheckBox ID="chkaCredito" runat="server" Text="Esta Nota de Venta es con Crédito"/>
   		 	   	...
   		 	   	<asp:Panel id="divaCredito" runat="Server">
   		 	   	<table>
   		 	   		...
   		 	   		Crédito :
                            ...
                            SelectCommand="SELECT LTRIM(Productores.apaterno + ' ' + Productores.amaterno + ' ' + Productores.nombre) + ' -  ' + CAST(Creditos.creditoID AS Varchar) AS Credito, Creditos.creditoID, Creditos.cicloID FROM Creditos INNER JOIN Productores ON Creditos.productorID = Productores.productorID WHERE (Creditos.statusID = 1) AND (Creditos.cicloID = @cicloID) AND pagado = 0 ORDER BY Credito">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="cmbCiclo" Name="cicloID" 
   		 	   			...
   		 	   			<asp:DropDownList ID="ddlCredito" runat="server"  
                                ...
                                ondatabound="ddlCredito_DataBound" 
                        ...
                        <td class="TablaField">
                            Fecha Pagaré:</td>
                        <td>
                            <asp:TextBox ID="txtFechaPagare" runat="server"></asp:TextBox>
                            <rjs:PopCalendar ID="PopCalendar7" runat="server" Control="txtFechaPagare" 
                                onselectionchanged="PopCalendar7_SelectionChanged" Separator="/" />
                        </td>
                    </tr>
   		 	   	    <tr>
                        <td colspan="2">
                            &nbsp;&nbsp;<asp:CheckBox ID="CheckBoxPersonaAutorizada" runat="server" 
                                Text="Persona Autorizada" />
                            <asp:Panel ID="pnlFirmasAutorizadas" runat="server">
                                <asp:DropDownList ID="dropDownListFirmas" runat="server">
                                </asp:DropDownList>
                            </asp:Panel>
                            <cc1:CollapsiblePanelExtender ID="pnlFirmasAutorizadas_CollapsiblePanelExtender" 
                                runat="server" CollapseControlID="CheckBoxPersonaAutorizada" Collapsed="True" 
                                Enabled="True" ExpandControlID="CheckBoxPersonaAutorizada" 
                                TargetControlID="pnlFirmasAutorizadas">
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="divaCredito_CollapsiblePanelExtender" 
                                                    runat="server" Enabled="True" TargetControlID="divaCredito" 
                                                    CollapseControlID="chkaCredito" Collapsed="True" ExpandControlID="chkaCredito">
                                                </cc1:CollapsiblePanelExtender>
                                            </td>
                                        </tr>
                                        </table>
...
&nbsp;<asp:Button ID="btnAgregarNotaV" runat="server" Text="Agregar Nota de Venta" 
                                                            ...
                                                            <tr>
																<td align="center">
                                                                    <asp:GridView ID="gvBoletas" runat="server" AutoGenerateColumns="False" 
                                                                        ...
                                                                        onrowdatabound="gvBoletas_RowDataBound" onrowdeleting="gvBoletas_RowDeleting">
                                                                        <Columns>
   ...
   <asp:Panel ID="pnladdproducto" runat="server">
                      ...
                      &nbsp;</td>
                                 ...
                                 <asp:TextBox ID="txtImporte" runat="server" ReadOnly="True" Visible="false"></asp:TextBox>  
   	                    		...
   	                    		<td>
   	                    			...
   	                    			<asp:CheckBox ID="chkTieneBoletas" runat="server" Text="Es con Boleta?" />
   	                    		...
   	                    		<td colspan="8" align="center">
                                       ...
                                       <asp:SqlDataSource ID="sqlProductos" runat="server" 
                                           ...
                                           SelectCommand="SELECT Productos.productoID, UPPER(Productos.Nombre + ' - ' + Unidades.Unidad + ' - ' + Presentaciones.Presentacion) AS Nombre FROM Productos INNER JOIN Presentaciones ON Productos.presentacionID = Presentaciones.presentacionID INNER JOIN Unidades ON Productos.unidadID = Unidades.unidadID WHERE (Productos.productoGrupoID = @grupoID) ORDER BY Nombre">
                                           <SelectParameters>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <table width="100%" align="left">
                                                        	<tr>
                                                        		<td align="center" class="TableHeader">
                                                                    	FERTILIZANTES AGREGADOS A LA NOTA DE VENTA</td>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:GridView ID="grdvProNotasVenta0" runat="server" 
                                                                        ...
                                                                        onrowupdating="grdvProNotasVenta0_RowUpdating" 
																		DataSourceID="sdsFertilizantes" onrowcancelingedit="grdvProNotasVenta0_RowCancelingEdit" 
                                                                        onrowupdated="grdvProNotasVenta0_RowUpdated" 
                                                                        onrowediting="grdvProNotasVenta0_RowEditing" 
                                                                        onrowdeleting="grdvProNotasVenta0_RowDeleting">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Cantidad" SortExpression="cantidad">
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox ID="textBoxCantidad" runat="server" 
                                                                                        Text='<%# Bind("cantidad", "{0:f2}") %>'></asp:TextBox>
                                                                                </EditItemTemplate>
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label2" runat="server" 
                                                                                        Text='<%# Bind("cantidad", "{0:N2}") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                            </asp:TemplateField>
																			...
																			<asp:TemplateField HeaderText="Precio" SortExpression="precio">
                                                                                ...
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox ID="textBoxPrecio" runat="server" Text='<%# Bind("precio") %>'></asp:TextBox>
                                                                                </EditItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                            </asp:TemplateField>
																			...
																			<asp:TemplateField HeaderText="tieneBoletas" SortExpression="tieneBoletas">
                                                                                <ItemTemplate>
                                                                                    <asp:CheckBox ID="CheckBox1" runat="server" 
                                                                                        Checked='<%# Bind("tieneBoletas") %>' Enabled="False" />
                                                                                </ItemTemplate>
                                                                                <EditItemTemplate>
                                                                                    <asp:CheckBox ID="checkBoxTieneBoleta" runat="server" 
                                                                                        Checked='<%# Bind("tieneBoletas") %>' />
                                                                                </EditItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                    </asp:GridView>
                                                                	<asp:SqlDataSource ID="sdsFertilizantes" runat="server" 
																		ConnectionString="<%$ ConnectionStrings:GaribayConnectionString %>" 
																		SelectCommand="SELECT * FROM [vDNVFertilizantes] WHERE ([notadeventaID] = @notadeventaID)" DeleteCommand="select 1" 
                                                                        UpdateCommand="select 1">
																		<SelectParameters>
																			<asp:ControlParameter ControlID="lblNumOrdenDeSalida" DefaultValue="-1" 
																				Name="notadeventaID" PropertyName="Text" Type="Int32" />
																		</SelectParameters>
																	</asp:SqlDataSource>
                                                                </td>
                                                                <td align="right" valign="bottom">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="TableHeader">
                                                                    OTROS PRODUCTOS AGREGADOS A LA NOTA DE VENTA</td>
                                                                <td align="right" valign="bottom">
                                                                    &nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:GridView ID="grdvProNotasVenta" runat="server" AutoGenerateColumns="False" 
																		...
																		DataSourceID="sdsNOFertilizante" onrowdeleting="grdvProNotasVenta_RowDeleting">
                                                                        <Columns>
                                                                            <asp:CommandField ButtonType="Button" CausesValidation="False" 
                                                                                ShowEditButton="True" />
																			<asp:CommandField ButtonType="Button" CausesValidation="False" 
                                                                            ...
                                                                            <asp:BoundField DataField="Nombre" HeaderText="Producto" ReadOnly="True" />
                                                                            <asp:TemplateField HeaderText="Presentacion" SortExpression="Presentacion">
                                                                                <EditItemTemplate>
                                                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("Presentacion") %>'></asp:Label>
                                                                                </EditItemTemplate>
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblPresentacionGrid" runat="server" 
                                                                                        Text='<%# Bind("Presentacion") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Cantidad" SortExpression="cantidad">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Precio" SortExpression="precio">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("precio", "{0:c2}") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <EditItemTemplate>
                                                                                    <asp:TextBox ID="textBoxPrecio" runat="server" 
                                                                                        Text='<%# Bind("precio", "{0:f2}") %>'></asp:TextBox>
                                                                                </EditItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Right" />
                                                                            </asp:TemplateField>
                                                                    ...
                                                                    <asp:SqlDataSource ID="sdsNOFertilizante" runat="server" 
																		ConnectionString="<%$ ConnectionStrings:GaribayConnectionString %>" 
																		SelectCommand="SELECT * FROM [vDNVNoFertilizante] WHERE ([notadeventaID] = @notadeventaID)" DeleteCommand="select 1" 
                                                                        UpdateCommand="select 1 ">
																		<SelectParameters>
																			<asp:ControlParameter ControlID="lblNumOrdenDeSalida" DefaultValue="-1" 
																				Name="notadeventaID" PropertyName="Text" Type="Int32" />
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:DropDownList ID="drpdlCatalogocuentaCajaChica" runat="server" 
                                                                                                                    ...
                                                                                                                    Height="23px" Width="256px" Enabled="False">
                                                                                                                </asp:DropDownList>
      ...
      <asp:Panel id = "pnlGuardarNota" runat="Server">
       <table>
        <tr>
            <td>
                NOTA: SI REALIZA ALGUNA MODIFICACION NO OLVIDE ACTUALIZAR LA NOTA</td>
        </tr>
          <tr>
              <td>
                  <asp:CheckBox ID="chkNVPagada" runat="server" Text="La nota esta pagada" />
              </td>
          </tr>
           <tr>
               <td>
                   ...
                   <asp:Button ID="btnPrintNotaVenta" runat="server" CausesValidation="False" 
                       onclick="btnPrintNotaVenta_Click" Text="Imprimir Nota" />
                   <asp:Button ID="btnDesbloquear" runat="server" onclick="btnDesbloquear_Click" 
                       Text="Desbloquear Nota" Visible="False" />
                   <br />
                   <asp:HyperLink ID="lnkImprimePagare" runat="server" 
                       NavigateUrl="~/frmNotadeVentaAddNew.aspx" Visible="False">IMPRIMIR PAGARE</asp:HyperLink>
               </td>
           </tr>
    </table>
    </asp:Panel>
