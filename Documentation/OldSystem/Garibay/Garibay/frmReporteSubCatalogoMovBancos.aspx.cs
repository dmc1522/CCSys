...
namespace Garibay
{
    public partial class frmReporteSubCatalogoMovBancos : Garibay.BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!this.IsPostBack)
            {
                ...
                this.drpdlCuentas.DataBind();
                this.DropDownListGrupo.DataBind();
                this.DropDownListCatalogoMov.DataBind();
        ...
        protected void DropDownListCatalogoMov_SelectedIndexChanged(object sender, EventArgs e)
        {
        }
